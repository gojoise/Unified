...
async function rememberPaths(key: 'ignoredPaths' | 'dismissedPaths', paths: string[]): Promise<void> {
...
export async function forgetPaths(key: 'ignoredPaths' | 'dismissedPaths'): Promise<void> {
  store[key] = []
